...
const Dashboard = () => {
  ...
  // Function to calculate income, expenses, and savings from transactions
  ...
  // Expense distribution data for chart
    ...
    <div className={dashboardStyles.container}>
      ...
      <div className={dashboardStyles.summaryGrid}>
        ...
        <FinancialCard
          ...
          label={`${timeFrameRange.label}'s Expenses`}
        ...
        <FinancialCard
          ...
          label={`${timeFrameRange.label}'s Savings`}
